...
if __name__ == "__main__":
  ...
  parser.add_argument('--modelname', default='modelfiles/multi_text8_e10_d300_vs2e-4_lr1e-5_margin1', type=str, help="The model to be evaluated. For instance, the files 'modelname.in', 'modelname.bin', etc should exist.")
