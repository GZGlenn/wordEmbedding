...
data_path = '/home/public/code/wordEmbedding/data/'
word2vec = tf.load_op_library(os.path.join(os.path.dirname(os.path.realpath(__file__)), data_path + 'word2vec_ops.so'))

flags = tf.app.flags

flags.DEFINE_string("save_path", 'modelfiles/t8-2s-e10-v05-lr05d-mc100-ss5-nwout-adg-win10', "Directory to write the model and "
                    "training summaries. (required)")
flags.DEFINE_string("train_data", data_path + 'text8', "Training text file. (required)")
